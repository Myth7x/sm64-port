...
DEFINE_LEVEL("DE_MARIEN",        LEVEL_DE_MARIEN,         COURSE_NONE, de_marien,       outside, 20000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("BHOP_CRAB_GAME",        LEVEL_BHOP_CRAB_GAME,         COURSE_NONE, bhop_crab_game,       outside, 20000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("MG_RETROLAND_FIX",        LEVEL_MG_RETROLAND_FIX,         COURSE_NONE, mg_retroland_fix,       outside, 20000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("KZ_BHOP_LIMINAL",        LEVEL_KZ_BHOP_LIMINAL,         COURSE_NONE, kz_bhop_liminal,       outside, 20000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("XC_KANJI_V1_0",        LEVEL_XC_KANJI_V1_0,         COURSE_NONE, xc_kanji_v1_0,       outside, 20000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("DE_INFERNO",        LEVEL_DE_INFERNO,         COURSE_NONE, de_inferno,       outside, 20000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("BHOP_SKY",        LEVEL_BHOP_SKY,         COURSE_NONE, bhop_sky,       outside, 20000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("DE_NUKE",        LEVEL_DE_NUKE,         COURSE_NONE, de_nuke,       outside, 20000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("BHOP_MONSTER_JAM",        LEVEL_BHOP_MONSTER_JAM,         COURSE_NONE, bhop_monster_jam,       outside, 20000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("BHOP_WONDERLAND",        LEVEL_BHOP_WONDERLAND,         COURSE_NONE, bhop_wonderland,       outside, 20000,    0x00, 0x00, 0x00, _,         _)
DEFINE_LEVEL("SURF_RNE",        LEVEL_SURF_RNE,         COURSE_NONE, surf_rne,       outside, 20000,    0x00, 0x00, 0x00, _,         _)
