...
#define AREA_BHOP_FUCKAPOY2_outside LEVEL_AREA_INDEX(LEVEL_BHOP_FUCKAPOY2, 1)
#define AREA_BHOP_ARCANE_outside     LEVEL_AREA_INDEX(LEVEL_BHOP_ARCANE, 1)
#define AREA_SURF_MENTOS_outside     LEVEL_AREA_INDEX(LEVEL_SURF_MENTOS, 1)
#define AREA_DE_DUST2_outside        LEVEL_AREA_INDEX(LEVEL_DE_DUST2, 1)
