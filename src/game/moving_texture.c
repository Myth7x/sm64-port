...
#define ssl_quicksand removed_level_u8_stub
#define ssl_pyramid_sand removed_level_u8_stub
#define ttc_yellow_triangle removed_level_u8_stub
#define castle_grounds_dl_waterfall removed_level_gfx_stub
#define castle_grounds_movtex_tris_waterfall removed_level_s16_stub
#define ssl_movtex_tris_pyramid_sand_pathway_front removed_level_s16_stub
#define ssl_dl_pyramid_sand_pathway_begin removed_level_gfx_stub
#define ssl_dl_pyramid_sand_pathway_end removed_level_gfx_stub
#define ssl_dl_pyramid_sand_pathway_front_end removed_level_gfx_stub
#define ssl_movtex_tris_pyramid_sand_pathway_floor removed_level_s16_stub
#define ssl_dl_pyramid_sand_pathway_floor_begin removed_level_gfx_stub
#define ssl_dl_pyramid_sand_pathway_floor_end removed_level_gfx_stub
#define ssl_movtex_tris_pyramid_sand_pathway_side removed_level_s16_stub
#define ssl_dl_pyramid_sand_pathway_side_end removed_level_gfx_stub
#define bitfs_movtex_tris_lava_first_section removed_level_s16_stub
#define bitfs_dl_lava_sections removed_level_gfx_stub
#define bitfs_movtex_tris_lava_second_section removed_level_s16_stub
#define bitfs_movtex_tris_lava_floor removed_level_s16_stub
#define bitfs_dl_lava_floor removed_level_gfx_stub
#define lll_movtex_tris_lava_floor removed_level_s16_stub
#define lll_dl_lava_floor removed_level_gfx_stub
#define lll_movtex_tris_lavafall_volcano removed_level_s16_stub
#define lll_dl_lavafall_volcano removed_level_gfx_stub
#define cotmc_movtex_tris_water removed_level_s16_stub
#define cotmc_dl_water_begin removed_level_gfx_stub
#define cotmc_dl_water_end removed_level_gfx_stub
#define cotmc_dl_water removed_level_gfx_stub
#define ttm_movtex_tris_begin_waterfall removed_level_s16_stub
#define ttm_dl_waterfall removed_level_gfx_stub
#define ttm_movtex_tris_end_waterfall removed_level_s16_stub
#define ttm_movtex_tris_begin_puddle_waterfall removed_level_s16_stub
#define ttm_dl_bottom_waterfall removed_level_gfx_stub
#define ttm_movtex_tris_end_puddle_waterfall removed_level_s16_stub
#define ttm_movtex_tris_puddle_waterfall removed_level_s16_stub
#define ttm_dl_puddle_waterfall removed_level_gfx_stub
#define ssl_movtex_tris_pyramid_quicksand removed_level_s16_stub
#define ssl_dl_quicksand_begin removed_level_gfx_stub
#define ssl_dl_quicksand_end removed_level_gfx_stub
#define ssl_dl_pyramid_quicksand removed_level_gfx_stub
#define ssl_movtex_tris_pyramid_corners_quicksand removed_level_s16_stub
#define ssl_dl_pyramid_corners_quicksand removed_level_gfx_stub
#define ssl_movtex_tris_sides_quicksand removed_level_s16_stub
#define ssl_dl_sides_quicksand removed_level_gfx_stub
#define ttc_movtex_tris_big_surface_treadmill removed_level_s16_stub
#define ttc_dl_surface_treadmill_begin removed_level_gfx_stub
#define ttc_dl_surface_treadmill_end removed_level_gfx_stub
#define ttc_dl_surface_treadmill removed_level_gfx_stub
#define ttc_movtex_tris_small_surface_treadmill removed_level_s16_stub
#define ssl_movtex_tris_quicksand_pit removed_level_s16_stub
#define ssl_dl_quicksand_pit_begin removed_level_gfx_stub
#define ssl_dl_quicksand_pit_end removed_level_gfx_stub
#define ssl_dl_quicksand_pit removed_level_gfx_stub
#define ssl_movtex_tris_pyramid_quicksand_pit removed_level_s16_stub
#define ssl_dl_pyramid_quicksand_pit_begin removed_level_gfx_stub
#define ssl_dl_pyramid_quicksand_pit_end removed_level_gfx_stub
#define bbh_movtex_merry_go_round_water_entrance removed_level_u8_stub
#define bbh_movtex_merry_go_round_water_side removed_level_u8_stub
#define ccm_movtex_penguin_puddle_water removed_level_u8_stub
#define inside_castle_movtex_green_room_water removed_level_u8_stub
#define inside_castle_movtex_moat_water removed_level_u8_stub
#define hmc_movtex_dorrie_pool_water removed_level_u8_stub
#define hmc_movtex_toxic_maze_mist removed_level_u8_stub
#define ssl_movtex_puddle_water removed_level_u8_stub
#define ssl_movtex_toxbox_quicksand_mist removed_level_u8_stub
#define sl_movtex_water removed_level_u8_stub
#define wdw_movtex_area1_water removed_level_u8_stub
#define wdw_movtex_area2_water removed_level_u8_stub
#define jrb_movtex_water removed_level_u8_stub
#define jrb_movtex_intial_mist removed_level_u8_stub
#define jrb_movtex_sinked_boat_water removed_level_u8_stub
#define thi_movtex_area1_water removed_level_u8_stub
#define thi_movtex_area2_water removed_level_u8_stub
#define castle_grounds_movtex_water removed_level_u8_stub
#define lll_movtex_volcano_floor_lava removed_level_u8_stub
#define ddd_movtex_area1_water removed_level_u8_stub
#define ddd_movtex_area2_water removed_level_u8_stub
#define wf_movtex_water removed_level_u8_stub
#define castle_courtyard_movtex_star_statue_water removed_level_u8_stub
#define ttm_movtex_puddle removed_level_u8_stub
